...
# Script to generate all the icons for the Audio Converter PWA

echo "Generating icons for the Audio Converter PWA..."
...
cat > www/manifest.json << EOF
{
  ...
  "short_name": "AudioConverter",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "A web-based audio converter using FFmpeg.wasm.",
  "icons": [
    {
